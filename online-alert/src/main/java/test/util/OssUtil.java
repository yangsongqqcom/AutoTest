...
public class OssUtil {
    ...
    private String accessKeyId = "LTAI4Fh3gTdTRL5vcnjQJfs7";

    private String accessKeySecret = "Sr3us8vCKl67gbOwVvhAgeiWrpi4zk";

    private String bucketName = "wangqioss";

    //文件存储目录
    private String filedir = "CCpicture/";
