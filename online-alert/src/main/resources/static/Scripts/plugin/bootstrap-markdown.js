...
!function (a) {
    ...
    b.prototype = {
        ...
        showEditor: function () {
            var b,
                ...
                h = this.$callback,
                i = this.$options,
                j = a("<div/>", { "class": "md-editor", click: function () { c.focus() } });
            if (null == this.$editor) {
        ...
        hidePreview: function () {
            this.$isPreview = !1;
            var a = this.$editor.find('div[data-provider="markdown-preview"]'); return a.remove(), this.enableButtons("all"), this.$textarea.show(), this.__setListener(), this
        },
        isDirty: function () {
        ...
        setSelection: function (a, b) {
            ...
            return ("selectionStart" in c && function () { c.selectionStart = a, c.selectionEnd = b } || function () { return null })()
        },
        ...
        enableButtons: function (a) {
            var b = function (a) { a.removeAttr("disabled") }; return this.__alterButtons(a, b), this
        },
        disableButtons: function (a) {
            var b = function (a) { a.attr("disabled", "disabled") }; return this.__alterButtons(a, b), this
        },
    ...
    a.fn.markdown.defaults = {
        ...
        },
        {
            ...
            data: [{
                ...
                callback: function (a) {
                    { var b, c, d, e = a.getSelection(); a.getContent() }
    ...
    var d = function (a) {
        var b = a; return b.data("markdown") ? void b.data("markdown").showEditor() : void b.markdown(b.data())
    },
    e = function (b) {
