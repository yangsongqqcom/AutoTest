...
!function (a) {
    ...
    var c = function (b, c) {
        ...
        this.isInput ? this.element.on({ focus: a.proxy(this.show, this), keyup: a.proxy(this.update, this) }) : this.component ? this.component.on({ click: a.proxy(this.show, this) }) : this.element.on({ click: a.proxy(this.show, this) }),
    ...
    c.prototype = {
        ...
        mousedown: function (b) {
            ...
            if (!e.is(".colorpicker")) {
                ...
                a(document).on({ mousemove: a.proxy(this.mousemove, this), mouseup: a.proxy(this.mouseup, this) }).trigger("mousemove")
            }
            return !1
        },
