    ...
    init: {
        ...
        FileUploaded: function (up, file, info) {
            if (info.status == 200) {
                ...
                $("#previewA").attr("href", imgPath);

                //$("#previewA").mouseover(function () {
                //    $(this).css('display', 'inline-block')
                //})
                //$("#previewA").mouseout(function () {
...
//$("#previewA").css("position", "relative").css("display", "inline-block").css("width", "140px").css("height", "95px");
