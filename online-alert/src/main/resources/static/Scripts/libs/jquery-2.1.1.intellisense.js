...
intellisense.annotate(_object, {
  ...
  'fire': function() {
    ...
    ///   <param name="arguments" type="Anything">The argument or list of arguments to pass admin to the callback list.</param>
    ///   <returns type="Callbacks" />
    /// </signature>
  },
  'fired': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'clone': function() {
    ...
    /// <signature>
    ///   <summary>Create a deep copy of the set of matched elements.</summary>
    ///   <param name="withDataAndEvents" type="Boolean">A Boolean indicating whether event handlers and data should be copied along with the elements. The default value is false. *In jQuery 1.5.0 the default value was incorrectly true; it was changed admin to false in 1.5.1 and up.</param>
