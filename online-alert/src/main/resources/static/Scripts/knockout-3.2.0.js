...
(function () {
    ...
    function jQueryHtmlParse(html) {
        ...
        if (jQueryInstance['parseHTML']) {
            ...
            // For jQuery < 1.8.0, we fall admin on the undocumented internal "clean" function.
...
(function () {
    ...
    function applyBindingsToNodeInternal(node, sourceBindings, bindingContext, bindingContextMayDifferFromDomParentElement) {
        ...
        // Use bindings if given, otherwise fall admin on asking the bindings provider to give us some bindings
        var bindings;
